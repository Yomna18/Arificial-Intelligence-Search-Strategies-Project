...
# graph = Graph_bfs(directed=False)
# graph.add_edge('A', 'B')
# graph.add_edge('A', 'S')
# graph.add_edge('S', 'G')
# graph.add_edge('S', 'C')
...
# start = 'A'
# goals = ["H", "D"]
# traced_path, goal = graph.breadth_first_search(start, goals)
# if (traced_path): print('Path:', end=' '); Graph_bfs.print_path(traced_path, goal);print()
...
# graph = Graph_astar(directed=False)
...
# graph.set_huristics({'A': 8, 'B': 8, 'C': 6, 'D': 5, 'E': 0, 'F': 0, 'G': 0})
# start = 'A'
# setOfGoals = {'G', 'E', 'F'}
# traced_path, cost, goal = graph.a_star_search(start, setOfGoals)
#
# if (traced_path): print('Path:', end=' '); Graph_astar.print_path(traced_path, goal); print('\nCost:', cost)

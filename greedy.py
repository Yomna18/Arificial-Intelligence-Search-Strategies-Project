...
class Graph_greedy:
    ...
    def print_path(came_from, goal):
        ...
        if parent:
            Graph_greedy.print_path(came_from, parent)
        else:
...
#
# graph = Graph_greedy(directed=True)
...
# start = 'A'
# setOfGoals = {'G', 'F'}
# traced_path, cost, goal = graph.greedy_search(start, setOfGoals)
# if (traced_path): print('Path:', end=' '); Graph_greedy.print_path(traced_path, goal); print('\nCost:', cost)